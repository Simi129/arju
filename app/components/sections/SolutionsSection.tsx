  ...
  return (
    <>
      ...
      <article className="relative col-span-1 md:col-span-1 rounded-[2rem] overflow-hidden border border-white/10 bg-neutral-900/50 hover:border-white/20 group transition-all duration-500 slide-up animate-delay-400">
        ...
        <div className="absolute inset-0 bg-cover bg-center opacity-40 md:group-hover:scale-110 transition-transform duration-700 bg-[url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=60&w=800&auto=format&fit=crop')] md:bg-[url('https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=2000&auto=format&fit=crop')]"></div>
        {/* Градиент оверлей */}
        ...
        <div className="p-8 h-full flex flex-col justify-end relative z-10">
          <div className="w-12 h-12 rounded-2xl bg-blue-500/20 border border-blue-500/20 flex items-center justify-center text-blue-400 mb-auto md:group-hover:scale-110 transition-transform duration-300">
      ...
      >
        {/* Оптимизированное фоновое изображение */}
        <div className="absolute inset-0 bg-cover bg-center opacity-30 md:group-hover:scale-110 transition-transform duration-700 bg-[url('https://images.unsplash.com/photo-1557804506-669a67965ba0?q=60&w=800&auto=format&fit=crop')] md:bg-[url('https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=2000&auto=format&fit=crop')]"></div>
        {/* Градиент оверлей */}
        ...
        <div className="p-8 flex-1 flex flex-col justify-center relative z-10">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 bg-pink-500/10 rounded-lg text-pink-400 backdrop-blur-sm border border-pink-500/20 md:group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="p-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center group/stat">
              <div className="text-3xl font-bold text-white mb-1 md:group-hover/stat:scale-110 transition-transform duration-300">25+</div>
              <div className="text-xs text-neutral-500 uppercase tracking-wider">
                {statsTranslations.clientsScaled}
              </div>
            </div>
            <div className="text-center group/stat">
              <div className="text-3xl font-bold text-white mb-1 md:group-hover/stat:scale-110 transition-transform duration-300">1,200+</div>
              <div className="text-xs text-neutral-500 uppercase tracking-wider">
                {statsTranslations.hoursSaved}
              </div>
            </div>
            <div className="text-center group/stat">
              <div className="text-3xl font-bold text-white mb-1 md:group-hover/stat:scale-110 transition-transform duration-300">99.8%</div>
              <div className="text-xs text-neutral-500 uppercase tracking-wider">
                {statsTranslations.systemUptime}
              </div>
            </div>
            <div className="text-center group/stat">
              <div className="text-3xl font-bold text-white mb-1 md:group-hover/stat:scale-110 transition-transform duration-300">340%</div>
              <div className="text-xs text-neutral-500 uppercase tracking-wider">
